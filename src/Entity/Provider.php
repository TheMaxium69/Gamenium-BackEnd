...
class Provider
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['postactu:read', 'provider:read','post:read','followProvider:read', 'follow:read', 'view:read', 'post:read', 'commentreply:admin', 'comment:admin'])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(['postactu:read', 'provider:read','post:read', 'follow:read', 'view:read', 'commentreply:admin', 'comment:admin'])]
    private ?string $tagName = null;

    #[ORM\Column(length: 255)]
    #[Groups(['postactu:read', 'provider:read','post:read', 'follow:read', 'post:read', 'commentreply:admin', 'comment:admin'])]
    ...
    #[Groups(['postactu:read', 'provider:read','post:read', 'follow:read', 'commentreply:admin', 'comment:admin'])]
