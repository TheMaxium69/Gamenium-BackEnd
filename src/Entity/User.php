...
class User implements UserInterface
{
    ...
    #[Groups(['badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'user:read', 'comment:read', 'commentreply:read', 'commentreply:admin', 'comment:admin', 'warn:read', 'post:read'])]
    private ?string $displayname_useritium = null;

    #[ORM\Column(length: 255)]
    #[Groups(['badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'default:read', 'screenshot:read', 'user:read', 'comment:read', 'historygame:read','taskusercompleted:read', 'view:read', 'commentreply:read', 'historyplateform:read', 'commentreply:admin', 'comment:admin', 'warn:read', 'post:read'])]
    private ?string $username = null;

    #[ORM\Column(length: 255)]
    #[Groups(['badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'user:read','comment:read', 'commentreply:read', 'warn:read', 'commentreply:admin', 'comment:admin'])]
    ...
    #[Groups(['badge:read','usermodo:read', 'testRate:read', 'log:read', 'useradmin:read', 'user:read', 'comment:read', 'commentreply:read', 'commentreply:admin', 'comment:admin', 'logrole:read', 'warn:read'])]
