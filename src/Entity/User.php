...
class User implements UserInterface
{
    ...
    #[Groups(['logcomment:read', 'historyplateform:read', 'historygame:read', 'logactu:read','badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'user:read', 'comment:read', 'commentreply:read', 'commentreply:admin', 'comment:admin', 'warn:read', 'post:read','userprovider:read'])]
    private ?string $displayname_useritium = null;

    #[ORM\Column(length: 255)]
    #[Groups(['logcomment:read', 'logactu:read','badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'default:read', 'screenshot:read', 'user:read', 'comment:read', 'historygame:read','taskusercompleted:read', 'view:read', 'commentreply:read', 'historyplateform:read', 'commentreply:admin', 'comment:admin', 'warn:read', 'post:read','userprovider:read'])]
    private ?string $username = null;

    #[ORM\Column(length: 255)]
    #[Groups(['logcomment:read', 'post:read', 'historyplateform:read', 'historygame:read', 'logactu:read','badge:read','usermodo:read', 'game:read', 'testRate:read', 'log:read', 'logrole:read', 'useradmin:read', 'user:read','comment:read', 'commentreply:read', 'warn:read', 'commentreply:admin', 'comment:admin','userprovider:read'])]
    ...
    #[Groups(['logcomment:read', 'post:read', 'historyplateform:read', 'historygame:read', 'logactu:read','badge:read','usermodo:read', 'testRate:read', 'log:read', 'useradmin:read', 'user:read', 'comment:read', 'commentreply:read', 'commentreply:admin', 'comment:admin', 'logrole:read', 'warn:read','userprovider:read'])]
